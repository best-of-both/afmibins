...
main(void)
{
	...
	ib::eulerian_grid<geometry, nx * ny * nz> u0, w0;
	ib::eulerian_grid<geometry, nx * (ny-1) * nz> v0;
	dt::vector<nx * nz> ut, ub, wt, wb;

	// Force components
	ib::eulerian_grid<geometry, nx * ny * nz> fx(1), fz;
	ib::eulerian_grid<geometry, nx * (ny-1) * nz> fy;
